...
/** Ventana principal de reproductor de vídeo, aa
...
public class VideoPlayer extends JFrame {
	...
	private DateFormat as = new SimpleDateFormat("yyyy-MM-dd");
	...
	public VideoPlayer() {
		...
		bAnyadir.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				listaRepVideos.add( path, JOptionPane.showInputDialog("Elige Filtro") );
	...
	private void lanzaVideo() {
		if (mediaPlayerComponent.getMediaPlayer()!=null &&
			...
			fecha = as.format(ficVideo.lastModified());
			lMensaje.setText(fecha);
	...
	private static File pedirCarpeta() {
		...
		int res = a.showOpenDialog(miVentana);
		File carpetaelegida = new File("");
	...
	public static void main(String[] args) {
		...
		if (args.length < 2) {
			...
			// TODO : Petición manual de ficheros con comodines (showInputDialog)
			 ficheros = JOptionPane.showInputDialog("Elige Filtro");
		} else {
			ficheros = args[0];
			path = args[1];
		}
